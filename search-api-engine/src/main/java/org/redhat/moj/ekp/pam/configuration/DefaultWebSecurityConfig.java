...
public class DefaultWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DefaultWebSecurityConfig.class);
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication().withUser("kieserver").password("password1!").roles("kie-server", "admin", "rest-all");
    }
