package org.redhat.moj.ekp.pam.configuration;
...
public class KieServerDeployer {
    ...
    CommandLineRunner deployAndValidate() {
        return new CommandLineRunner() {
            ...
            public void run(final String... strings) throws Exception {
                ...
                final List<KieContainerResource> result = kieServer
                        .listContainers(KieContainerResourceFilter.ACCEPT_ALL).getResult().getContainers();
                result.forEach(c -> {
                ...
                kjars.forEach(k -> {
                    final KieContainerResource resource = new KieContainerResource(k.getContainerId(),
                            k.getReleaseId());
    ...
    private boolean isDeployed(final KieContainerResource resource, final List<KieContainerResource> result) {
    ...
    public void setKjars(final List<KJAR> kjars) {
        this.kjars = kjars;
    }
}
